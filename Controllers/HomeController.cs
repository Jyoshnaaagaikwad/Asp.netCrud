...
namespace MyCrudApp.Controllers
{
    public class HomeController : Controller
    {
      ...
      private readonly string conn = "server=LENOVO\\SQLEXPRESS;database=Employee_management_System;MultipleActiveResultSets=True;Integrated Security=False;trusted_connection=true;Encrypt=false";
